		...
		<?php
			...
			echo '<div class="container-settings-form">';
					...
					echo '<form action="upload_image.php" method="POST" enctype="multipart/form-data">';
						echo '<h2 id="upload-error">Something went wrong. Try again.</h2>';
						echo '<input class="button wide-button green-button" type="file" name="fileToUpload" id="fileToUpload"></br>';
						echo '<input class="button wide-button green-button" type="submit" name="edit" value="Upload">';
					echo '</form>';
